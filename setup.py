...
with open(os.path.join(here, 'hera_wr_cm', '__version__.py'), 'w') as fh:
...
setup_args = dict(name="hera_wr_cm",
                  maintainer="HERA Team",
                  description="Library for interfacing with the HERA White Rabbit nodes",
